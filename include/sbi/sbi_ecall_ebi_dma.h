...
typedef struct {
	sunxi_dma_channel_config channel_cfg;
...
typedef struct {
	...
	sunxi_dma_channel_reg channel[16]; /* 0x100 dma channel register */
} sunxi_dma_reg;

typedef struct sunxi_dma_source_t {
	unsigned int used;
	unsigned int channel_count;
	sunxi_dma_channel_reg *channel;
