...
# define __iomem
#define printf print_console
#define printk print_console
#define panic(x)
...
extern uintptr_t DRV_CONSOLE_ADDR;
extern void (* printd_ptr)(const char* s, ...);
// needs to rewrite
void print_console(char* fmt, ...);
// #define print_console(fmt, args...)  (*printd_ptr)(fmt, ##args)
